<?php
  ...
  if(isset($_POST['legality'])) {
    ...
    try {
      $stmt = $auth_user->runQuery("UPDATE contents SET legality=:legality WHERE c_id='1'");     
      $stmt->execute(array(':legality'=>$legality));
    }
    catch(PDOException $e) {
      echo $e->getMessage();
    }
    $auth_user->redirect(BASE_URL.'administrator/content-legality?updated');
    exit();
  }
?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            <small>Dashboard / Contents / Legality</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-11 col-sm-12 col-xs-12">
                                   <div class="form-group">
                                      ...
                                      <textarea class="form-control" name="legality" id="legality" rows="20"
                                      ><?php if(isset($legality)){echo $legality;}else{echo $content['legality'];}?></textarea>
                                    </div>
                                </div>
                            </div>
                            <br><br>
