<?php
	...
	$testimonies = $auth_user->pendingTestimonies();
	...
	if(isset($_POST["approve"])) {
		...
		for($i = 0; $i < $cnt; $i++) {
			$rowID = $_POST['tick'][$i];
			try  {
                $stmt = $auth_user->runQuery("SELECT * FROM testimonies
                ...
                $stmt->execute(array(':loginID'=>$rowFound['login_id']));               
            }
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            <small>Dashboard / Testimonials / Pending</small>
                        </h1>
                    </div>
                </div>
                <!-- /. ROW  -->
