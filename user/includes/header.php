...
<head>
    ...
    <title>User Dashboard - <?php if(isset($siteInfo['site_name'])){echo $siteInfo['site_name'];}?></title>
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            ...
            <ul class="nav navbar-top-links navbar-right">                
                <!-- /.dropdown -->
                <?php include(ROOT_PATH."user/includes/topNotification.php") ?>
                <!-- /.dropdown -->
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false">
                        <i class="fa fa-user fa-fw"></i><?php if(isset($userInfo["username"])){echo $userInfo["username"]; } ?> <i class="fa fa-caret-down"></i>
                    </a>
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="<?php echo BASE_URL;?>user/change-password">
                        <i class="fa fa-gear fa-fw"></i> Change Password</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="<?php echo BASE_URL;?>logout?true">
